...
#include "bitmaps.h"
#include "display.h"
#include "scenes.h"        // включає animations_list.h → animation.h
#include "button.h"        // після scenes.h бо використовує animSceneInit()
...
void loop() {
  ...
  switch (currentScene) {
    case 0: drawScene0(); break;   // Анімації
    case 1: drawScene1(); break;   // Clock
    case 2: drawScene2(); break;   // IMU
    case 3: drawScene3(); break;   // ENV
    case 4: drawScene4(); break;   // Tilt
  }
}