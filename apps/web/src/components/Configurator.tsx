...
export default function Configurator() {
  ...
  return (
    <div
      id="configurator"
      className="w-full max-w-4xl mt-32 border border-nothing-border bg-nothing-gray/20 rounded-3xl overflow-hidden backdrop-blur-sm"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-nothing-border">
        {/* Керування */}
        <div
          className={`p-8 space-y-6 transition-opacity duration-300 ${status === 'connected' ? 'opacity-100' : 'opacity-40 pointer-events-none'}`}
        >
          <div>
          ...
          <div>
            ...
            <form onSubmit={handleSendText} className="flex gap-2">
              ...
              <button
                type="submit"
                className="border border-nothing-border px-4 py-2 hover:bg-white hover:text-black transition-colors"
              >
