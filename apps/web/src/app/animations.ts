...
export const KURUMACHI_ANIMATIONS: AnimationItem[] = [
  ...
  { id: 'EMOTION_UWU', name: 'UwU Mode', gifName: 'emotion_uwu.gif', category: 'emotions' },
  {
    id: 'EMOTION_LOVE_01',
    name: 'Heart Eyes',
    gifName: 'emotion_love_01.gif',
    category: 'emotions',
  },
  {
    id: 'EMOTION_ANGRY_FIRE',
    name: 'Rage Mode',
    gifName: 'emotion_angry_fire.gif',
    category: 'emotions',
  },
  { id: 'ACTION_EAT', name: 'Eating Snack', gifName: 'action_eat.gif', category: 'actions' },
  {
    id: 'ACTION_SLEEPY',
    name: 'Going to Sleep',
    gifName: 'action_sleepy.gif',
    category: 'actions',
  },
  {
    id: 'ACTION_PINGPONG',
    name: 'Playing Ping-Pong',
    gifName: 'action_pingpong.gif',
    category: 'actions',
  },
